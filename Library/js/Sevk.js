    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if (json != "") {
                ...
                $(".AllActivities").html("<h5 class='PartHead MotionHead'>Tüm Çıkışlar <i data-icon-name='OpenInNewWindow'  style='float:right;color:#fff !important;' role='presentation' aria-hidden='true' class='ms-Button-icon printwaybill  iconnewWindow'></i></h5><table class='MotionDetails table table-hover '>" +
