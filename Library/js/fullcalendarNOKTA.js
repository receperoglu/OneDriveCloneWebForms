(function (t) {
    ...
    function s(n, r) {
        ...
        function p(e) {
            ye++, ce && (Q("viewDestroy", ce, ce, ce.element), N(), ce.triggerEventDestroy(), $(), ce.element.remove(), oe.deactivateButton(ce.name)), oe.activateButton(e), ce = new _e[e](t("<div id='govde' class='fc-view fc-view-" + e + "' />").appendTo(se), te), g(), V(), ye--
        }
    ...
    function J(e, n, r) {
        ...
        function u(t) {
            ...
            return t.month() != e && i.push("fc-other-month"), t.isSame(r, "day") ? i.push("fc-today", re + "-state-highlight") : r > t ? i.push("fc-past") : i.push("fc-future"), a += "<td class='" + i.join(" ") + "'" + " data-date='" + t.format() + "'" + ">" + "<div>", Q && (a += "<div   data-date='" + t.format() + "' style='color:#2980B9' class='fc-day-number ekle pull-left'>+</div><div    data-date='" + t.format() + "' class='fc-day-number gun'>" + t.date() + "</div>"), a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>"
        }
    ...
    function me() {
        ...
        function l(t) {
            ...
            S(r) && o.push("fc-event-draggable"), t.isStart && o.push("fc-event-start"),
            t.isEnd && o.push("fc-event-end"), o = o.concat(r.className),
            r.source && (o = o.concat(r.source.className || []));
            var i = A(r, C);
            //alt satırdaki href yerine id geliyor unutma
           

             return e += a ? "<a data-spinner='true' class='primary popoveryakalama' id='"
                + R(a) + "'" : "<div class='sonradaneklenenolay' data-id='" + R(a) + "'",
                e += "  style='position:absolute;left:" + t.left + "px;" + i + ">" +
                "<div  class='fc-event-inner'>",
                !r.allDay && t.isStart && (e += "<span class='fc-event-time'>"
                + R(T.getEventTimeText(r)) + "</span>"),
                e += "<span  class='fc-event-title'>" + R(r.title || "")
                + "<span class='fa fa-calendar'></span>" + "</span>" + "</div>",
                r.allDay && t.isEnd && k(r) && (e += "<div class='ui-resizable-handle ui-resizable-"
                + (n ? "w" : "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"),
                e += "</" + (a ? "a" : "div") + ">"
        ...
        function d(t, e) {
            ...
            be(t, function (t, e) {
                e.css("top", (o[t.row] + t.top))   //t.top tepeye olan uzaklığa ekliyor hücre bazlı açıklama
            })
        }
    ...
    var xe = {
        ...
        defaultView: "month",
        defaultDate: '2016-10-09', //açıklama
        aspectRatio: 1.35,
        header: {
            left: "title",
            center: "",
