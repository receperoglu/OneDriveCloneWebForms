    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                while (okur.Read())
                {
                    if (personel == okur["kisiid"].ToString())
                    {
                        ...
                        olaylarsonuc += "<div class='pull-right baslikspeakers'>" + " <div class='speakerspadding from-me'    id='speakers" + okur["kisi"].ToString() + "' data-id='" + okur["kisi"].ToString() + "' >" + okur["konusma"].ToString() + "</div> </div><div class='clearfix'></div> ";


                    }
                    else
                    {
                        isim = okur["kisi"].ToString();

                        olaylarsonuc += "<div class='pull-left baslikspeakers'> <div class='speakerspadding from-them'  id='speakers" + okur["kisi"].ToString() + "' data-id='" + okur["kisi"].ToString() + "'> " + "   " + okur["konusma"].ToString() + "</div></div><div class='clearfix'></div> ";
            ...
            finally
            {
                ...
                context.Response.Write("<div class='konusmabasligi' style='top:0px;width:380px; position:fixed;z-index:999;text-align:center;margin:0 auto;'>" + isim + "</div><br>" + olaylarsonuc + "<span style='display:none' id='enalt'></span>");
